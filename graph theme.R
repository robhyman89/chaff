          ...
          base_rect_size = base_size/22) 
{
  ...
  t <- theme(line = element_line(colour = "blue", size = base_line_size, 
                                 linetype = 1, lineend = "butt"), rect = element_rect(fill = "purple", 
                                                                                      colour = "red", size = base_rect_size, linetype = 1), 
             text = element_text(family = base_family, face = "plain", 
                                 colour = "green", size = base_size, lineheight = 0.9, 
                                 hjust = 0.5, vjust = 0.5, angle = 0, margin = margin(), 
                                 debug = FALSE), axis.line = element_blank(), axis.line.x = NULL, 
             axis.line.y = NULL, axis.text = element_text(size = rel(0.8), 
                                                          colour = "orange"), axis.text.x = element_text(margin = margin(t = 0.8 * 
